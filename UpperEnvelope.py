...
""",
    ...
    def execute(self, context):
        ...
        self.ObjFindUpperEnvelope(context.object)
    ...
    def ObjFindUpperEnvelope(self, obj: bpy.types.Object) -> bpy.types.Object:
        ...
        # 生成 upper envelope
        newObj = self.PolygonsToUpperEnvelopeObj(f"{obj.name} Upper Envelope", polygons)
    ...
    def PolygonsToUpperEnvelopeObj(self, name: str, polygons: list[Polygon]) -> bpy.types.Object:
        """
        對所有 Polygon 找 Upper Envelope，找出來的 Upper Envelope 會儲存在名為 name 的物件

        :param name: 新物件的名稱
        :param polygons: 所有面的多邊形
        """
